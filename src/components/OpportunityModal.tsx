...
export function OpportunityModal({ onClose, lang, type }: { onClose: () => void, lang: string, type: 'volunteer' | 'vacancy' | 'internship' }) {
  ...
  return (
    ...
    >
      <div className="bg-[var(--color-bg)] w-full h-[100dvh] md:h-auto md:max-w-4xl md:max-h-[90vh] overflow-hidden rounded-none border-0 md:border md:border-[var(--color-border)] relative flex flex-col">
        <button 
          onClick={onClose}
